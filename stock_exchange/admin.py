...
class BuyerAdmin(admin.ModelAdmin):
    list_display = ('id', 'full_name', 'address', 'phone', 'email')  # Поля для отображения в админке
    search_fields = ('full_name', 'email')  # Поля для поиска
...
class DealAdmin(admin.ModelAdmin):
    ...
    search_fields = ('buyer__full_name', 'company__name')  # Поля для поиска
