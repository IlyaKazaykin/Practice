...
def company_list(request):
    companies = Company.objects.all() # Получение всех объектов модели Company
    return render(request, 'company_list.html', {'companies': companies})

def buyer_list(request):
    buyers = Buyer.objects.all()  # Получение всех объектов модели Buyer
    return render(request, 'buyer_list.html', {'buyers': buyers})

def deal_list(request):
    deals = Deal.objects.all()  # Получение всех объектов модели Deal
